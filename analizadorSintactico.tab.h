...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    WHILE = 264,                   /* WHILE  */
    FLOAT = 265,                   /* FLOAT  */
    CTE_LOGICA = 266,              /* CTE_LOGICA  */
    CTE_ENTERA = 267,              /* CTE_ENTERA  */
    CTE_FLOAT = 268,               /* CTE_FLOAT  */
    ID = 269,                      /* ID  */
    OP_SUMA = 270,                 /* OP_SUMA  */
    OP_PROD = 271,                 /* OP_PROD  */
    OP_RESTA = 272,                /* OP_RESTA  */
    OP_DIV = 273,                  /* OP_DIV  */
    OP_DIVENT = 274,               /* OP_DIVENT  */
    OP_MENOR = 275,                /* OP_MENOR  */
    OP_MAYOR = 276,                /* OP_MAYOR  */
    OP_EQ = 277,                   /* OP_EQ  */
    OP_AND = 278,                  /* OP_AND  */
    OP_OR = 279,                   /* OP_OR  */
    OP_NEG = 280,                  /* OP_NEG  */
    OP_ASIG = 281,                 /* OP_ASIG  */
    PUNTO_COMA = 282,              /* PUNTO_COMA  */
    PAR_IZQ = 283,                 /* PAR_IZQ  */
    PAR_DER = 284,                 /* PAR_DER  */
    LLAVE_IZQ = 285,               /* LLAVE_IZQ  */
    LLAVE_DER = 286,               /* LLAVE_DER  */
    COMA = 287,                    /* COMA  */
    SIGNO_MENOS = 288              /* SIGNO_MENOS  */
  };
